...
View the [sample copy spreadsheet](https://docs.google.com/spreadsheet/pub?key=0AqjLQISCZzBkdDIwS0xnRWFaTjY0LTVWQ1dVcm13N2c#gid=0).
...
def read_my_google_doc():
    ...
    get_document('0AqjLQISCZzBkdDIwS0xnRWFaTjY0LTVWQ1dVcm13N2c', file_path)
    data = Copy(file_path)
...
```
* * * * * ubuntu bash /home/ubuntu/apps/grad_rates/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
